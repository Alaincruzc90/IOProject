...
public class SetConfigWindow extends javax.swing.JFrame {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        if (validSave) {
            ...
            graphicalInterfaceController.setRepetitions(Integer.parseInt(jTextField1.getText()));
            graphicalInterfaceController.setSimulationTime(Double.parseDouble(jTextField2.getText()));
            ...
            graphicalInterfaceController.setConcurrentConnections(Integer.parseInt(jTextField3.getText()));
            graphicalInterfaceController.setProcessingAvailableProcesses(Integer.parseInt(jTextField4.getText()));
            graphicalInterfaceController.setTransactionsAvailableProcesses(Integer.parseInt(jTextField5.getText()));
            graphicalInterfaceController.setExecutionAvailableProcesses(Integer.parseInt(jTextField6.getText()));
            graphicalInterfaceController.setTimeOut(Double.parseDouble(jTextField7.getText()));
            previousWindow.setVisible(true);
            this.dispose();
        }
