...
public class GUIController {
    ...
    public void startSimulation() {
        ...
        simulation = new Simulation(simulationTime,repetitions,concurrentConnections,processingAvailableProcesses,transactionsAvailableProcesses, executionAvailableProcesses, timeOut, true);
